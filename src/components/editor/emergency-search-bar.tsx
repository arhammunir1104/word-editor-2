 ...
 * 
 * This is a simplified search bar component that uses our emergency search implementation.
 * It's designed to be reliable and direct, bypassing all the complexity of the regular search.
 */
import React, { useState, useEffect, useRef } from 'react';
import { Editor } from '@tiptap/core';
import { useSearchReplaceStore } from '../../lib/search-replace-store';
import { EmergencySearcher, createEmergencySearcher } from './emergency-search';
...
export default function EmergencySearchBar({ editor, historyManager }: EmergencySearchBarProps) {
  ...
  const searcherRef = useRef<EmergencySearcher | null>(null);
  
  // Initialize the emergency searcher when the editor is ready
  useEffect(() => {
    if (editor) {
      searcherRef.current = createEmergencySearcher(editor);
      console.log("Emergency search initialized");
    }
  ...
  useEffect(() => {
    ...
    const searchDelay = setTimeout(() => {
      console.log(`🚨 EMERGENCY SEARCH: Searching for "${searchTerm}"`);
